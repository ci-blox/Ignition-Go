...
|
*/
$config['base_url'] = 'http://igo.local/';
...
// set the default timezone for the user registration page 
...
// log_activity method. If this is false, you can remove the Activity blox
