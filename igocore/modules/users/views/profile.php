...
<div class="form-group<?php echo form_error('username') ? ' error' : ''; ?>">
    ...
    <div class='controls'>
        <input id='username' class='form-control' type='text' disabled="disabled" required='required' name='username' maxlength='30' value="<?php echo set_value('username', isset($user->username) ? $user->username : ''); ?>" />
...
<div class="form-group<?php echo form_error('first_name') ? ' error' : ''; ?>">
    ...
    <div class='controls'>
        <input id='first_name' class='form-control' type='text' disabled="disabled" required='required' name='first_name' maxlength='30' value="<?php echo set_value('first_name', isset($user->first_name) ? $user->first_name : ''); ?>" />
...
<div class="form-group<?php echo form_error('last_name') ? ' error' : ''; ?>">
    ...
    <div class='controls'>
        <input id='last_name' class='form-control' type='text' disabled="disabled" required='required' name='last_name' maxlength='30' value="<?php echo set_value('last_name', isset($user->last_name) ? $user->last_name : ''); ?>" />
...
<div class="form-group<?php echo form_error('timezone') ? ' error' : ''; ?>">
    ...
    <div class='controls'>
        <input id='timezone' class='form-control' type='text' disabled="disabled" required='required' name='timezone' maxlength='30' value="<?php echo set_value('timezone', isset($user->timezone) ? $user->timezone : ''); ?>" />
