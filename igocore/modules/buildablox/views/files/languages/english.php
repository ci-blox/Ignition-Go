...
\$lang['{$module_name_lower}_create_failure']  = 'There was a problem creating the {$module_name}: ';
...
\$lang['{$module_name_lower}_delete_confirm']  = 'Are you sure you want to delete this {$module_name}?';
