            ...
            <fieldset id="db_details">
                ...
                <div id="field_numbers" class="form-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <a href="<?php echo site_url(SITE_AREA . '/buildablox/create_module/' . $field_numbers[$ndx]); ?>"<?php echo $field_numbers[$ndx] == $field_total ? ' class="current"' : ''; ?>>
