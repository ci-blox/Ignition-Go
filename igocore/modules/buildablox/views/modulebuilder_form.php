...
<div class='content-header buildablox'>
    ...
    <div class="alert alert-danger">
        ...
        <strong><?php echo lang('mb_form_errors'); ?></strong>
    ...
    <div class='col-md-12'>
        <div class='card card-primary'>
            <div class='card-body'>
<div class="module-builder admin-card">
        <?php
        ...
        ?>
            <fieldset id="module_details">
                ...
                <div class="form-group<?php echo form_error('entity_name') ? ' error' : ''; ?>">
                    <div class="col-sm-3"><label for="entity_name" class="control-label"><?php echo lang('mb_form_entity_name'); ?></label></div>
                    <div class="controls col-sm-9">
                        <input name="entity_name" id="entity_name" type="text" value="<?php echo set_value("entity_name"); ?>" placeholder="<?php echo lang('mb_form_entity_name_ph'); ?>" />
                ...
                <div class="form-group<?php echo form_error('entity_plural') ? ' error' : ''; ?>">
                    ...
                    <div class="controls col-sm-9">
                        ...
                        <span class="help-inline"><?php echo form_error('entity_plural'); ?></span>
                    </div>
                </div>
                <div class="form-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
                    <div class="col-sm-3"><label for="module_name" class="control-label"><?php echo lang('mb_form_mod_name'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="controls col-sm-9" id='mb_module_db'>
                     <div class="btn-group dbopt" data-toggle="buttons">
                        ...
                        <label class="btn btn-default" for="db_create">
                        ...
                        <label class="btn btn-default" for="db_exists">
            ...
            <fieldset id="db_details">
                ...
                <div class="form-group mb_advanced<?php echo form_error('table_name') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="table_name" class="control-label"><?php echo lang('mb_form_table_name'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="form_error_delimiters" class="control-label"><?php echo lang('mb_form_err_delims'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced">
                    <div class='col-sm-3'><label for="textarea_editor" class="control-label"><?php echo lang('mb_form_text_ed'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced">
                    <div class="controls col-sm-9">
                        <div class='col-sm-3'><label for="use_pagination" class="checkbox">
                ...
                <div class="form-group mb_advanced">
                    <div class="controls col-sm-9">
                        <div class='col-sm-3'><label for="log_user" class="checkbox">
                ...
                <div class="form-group mb_advanced">
                    <div class="controls col-sm-9">
                        <div class='col-sm-3'><label for="use_soft_deletes" class="checkbox">
                ...
                <div class="form-group mb_advanced<?php echo form_error('soft_delete_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="soft_delete_field" class="control-label"><?php echo lang('mb_soft_delete_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced<?php echo form_error('deleted_by_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="deleted_by_field" class="control-label"><?php echo lang('mb_deleted_by_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced">
                    <div class="controls col-sm-9">
                        <div class='col-sm-3'><label for="use_created" class="checkbox">
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="created_field" class="control-label"><?php echo lang('mb_form_created_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_by_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="created_by_field" class="control-label"><?php echo lang('mb_form_created_by_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced">
                    <div class="controls col-sm-9">
                        <div class='col-sm-3'><label for="use_modified" class="checkbox">
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="modified_field" class="control-label"><?php echo lang('mb_form_modified_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_by_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="modified_by_field" class="control-label"><?php echo lang('mb_form_modified_by_field'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                //--------------------------------------------------------------
                ?>
                <div class="alert alert-info mb_new_table">
                    <a class="close" data-dismiss="alert">&times;</a>
                    <?php echo lang('mb_table_note'); ?>
                </div>
                <div class="form-group mb_new_table<?php echo form_error('primary_key_field') ? ' error' : ''; ?>">
                    <div class='col-sm-3'><label for="primary_key_field" class="control-label"><?php echo lang('mb_form_primarykey'); ?></label></div>
                    <div class="controls col-sm-9">
                ...
                <div id="field_numbers" class="form-group">
                    <label class="control-label"><?php echo lang('mb_form_fieldnum'); ?></label></div>
                    <div class="controls col-sm-9">
                        <?php
            ...
            <div id="all_fields">
                ...
                <fieldset id="field<?php echo $count; ?>_details">
                    ...
                    <div class="form-group<?php echo form_error($viewFieldLabel) ? ' error' : ''; ?>">
                        <div class='col-sm-3'><label class="control-label" for="<?php echo $viewFieldLabel; ?>"><?php echo lang('mb_form_label'); ?></label></div>
                        <div class="controls col-sm-9">
                    ...
                    <div class="form-group<?php echo form_error($viewFieldName) ? ' error' : ''; ?>">
                        <div class='col-sm-3'><label class="control-label" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label></div>
                        <div class="controls col-sm-9">
                    ...
                    <div class="form-group <?php echo form_error($dbFieldLength) ? 'error' : ''; ?>">
                        <div class='col-sm-3'><label class="control-label" for="<?php echo $dbFieldLength; ?>"><?php echo lang('mb_form_length'); ?></label></div>
                        <div class="controls col-sm-9">
