...
class Modulebuilder
{
    ...
    /** @var array Various settings from the config file. */
    ...
    public function __construct()
    {
        ...
        // Get the options from the buildablox config file.
        $this->CI->load->config('buildablox');
        $this->options = $this->CI->config->item('buildablox');
